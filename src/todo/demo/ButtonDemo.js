...
export default () => {
    ...
    return (
        <React.Fragment>
            ...
            <Container>
                <Button action="text" isLoading={isLoading} onClick={handleClick}>Click to load</Button>
                <Button bg="#138496" color="#FBFBFB" action="icon" isLoading={isLoading2} onClick={handleClick2}>Click to load</Button>
                <Button bg="#138496" color="#FBFBFB" action="icon" size="lg" isLoading={isLoading3} onClick={handleClick3}>Click to load</Button>
            </Container>
            <h2>Block Buttons</h2>
            <Container>
